    ...
    >
      <div id="monitor" class="relative">
        ...
        >
          ...
          >
            ...
            <div class="flex ml-auto top-menu-right">
              ...
              <a
                ...
                class="github tooltip tooltip-bottom"
                data-tip="Github"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            class="welcome absolute z-10 text-8xl text-white text-bold w-full h-full flex justify-center items-center opacity-80"
          ...
          >
            ...
            <div
              ...
              @click="switchWindow('game')"
            >
              <div class="icon"></div>
              <div class="name">Game</div>
            </div>
            <div
              class="desktop-item item-resume"
              @click="switchWindow('resume')"
            >
              <div class="icon"></div>
              <div class="name">Resume.pdf</div>
            </div>
            <div
              class="desktop-item item-contact"
              @click="switchWindow('contact')"
            >
              <div class="icon"></div>
            ...
            <div class="side-grid">
              ...
              <Transition>
                <div class="folder" v-show="folders.projects">
                  <div
                    class="desktop-item item-gol"
                    @click="openUrl('http://gol.trofimov.ca')"
                  >
                    <div class="icon"></div>
